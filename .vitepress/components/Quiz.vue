  ...
  <div v-else-if="stage === 'quiz'">
    ...
    >
      ...
      <div style="flex:2;">
        ...
        <ul>
          <li v-for="(a, j) in q.answers" :key="j" style="margin-bottom:0.5rem;">
            <div
            ...
            <p v-if="openAnswer === j" style="margin-left:1rem; margin-top:0.3rem;">
              {{ a.explanation }}
            </p>
          </li>
        </ul>

        <button :disabled="!answeredCorrectly" @click="nextQuestion" style="margin-top:1rem; padding:0.5rem 1rem;">
